...
- Complete: Make a google analytics account if you have not already done so
...
- Complete: in `_quarto.yml` update the Google Analytics tracking number on line 7 with the
